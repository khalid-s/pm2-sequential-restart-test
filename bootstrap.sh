...
sudo npm install -g typescript gulp-cli concurrently typings grunt-cli bower cordova ionic pm2 forever express-generator nodemon@1.10.1 strongloop @angular/cli
...
echo -e "$Cyan \n Updating nginx configs and adding hosts configs $Color_Off"
...
echo -e "$Cyan \n installing Projects dependencies $Color_Off"
